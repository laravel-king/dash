...
const perks = [
    ...
    },
    {
        ...
        icon: CheckCircle,
        description: "Every asset in on our platform is verified by our team to ensure our higher quality standards. Not happy? We offer a 30-days money back guarantee."
    },
    {
        name: "For The Planet",
        icon: LeafIcon,
      ...
      <>
          <MaxWidthWrapper>
            <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
                ...
                <p className="mt-6 text-lg max-w-prose text-muted-foreground">Welcome to Dash. Every asset on our platform is verified by our team to ensure our highest quality standards</p>
